...
assert_no_tmp_global_vars_set() {
    ...
    assert "-z $DEFAULT_GRADLE_VERSION" \
	   "DEFAULT_GRADLE_VERSION is set: $DEFAULT_GRADLE_VERSION"
    assert "-z $GRADLE_VERSION" \
	   "GRADLE_VERSION is set: $GRADLE_VERSION"
}

assert_clean_env() {
    assert_no_tmp_global_vars_set
    assert "-z $SETUP_GRADLE_ORIGINAL_PATH" \
	   "SETUP_GRADLE_ORIGINAL_PATH is set: $SETUP_GRADLE_ORIGINAL_PATH"
...
should_successfully_use_default_version_if_no_version_given() {
    ...
    assert_no_tmp_global_vars_set
    assert "${SETUP_GRADLE_ORIGINAL_PATH// /§} = ${SPT_ORIGINAL_PATH// /§}" \
	"SETUP_GRADLE_ORIGINAL_PATH != SPT_ORIGINAL_PATH: $SETUP_GRADLE_ORIGINAL_PATH"
